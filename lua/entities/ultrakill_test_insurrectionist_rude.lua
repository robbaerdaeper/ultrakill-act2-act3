...
-- Insurrectionist "Rude" — синяя половина секретного дуэта 6-1
-- "CRY FOR THE WEEPER". Канон-материал SisyphusBlue (T_ArmStretcherBlue).
...
UKSisy.ApplyVariant( ENT, {
  name = "Rude",
  bossTitle = 'INSURRECTIONIST "RUDE"',
  material = "models/ultrakill_prelude_test/insurrectionist/sisy_body_blue",
  partner = "ultrakill_test_insurrectionist_angry",
} )
